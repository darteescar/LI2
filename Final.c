...
void insereCombNaMatriz (wchar_t matrizCartas[], wchar_t matriz[][2], int numElementosPorLinhaNaLinhaJ) {
...
void geraDuplasSequencias6 ( wchar_t** matrizCartas, int j, int i, int i1 , int i2) {
    ...
    insereCombNaMatriz (matrizCartas[j], matriz1, i);
    insereCombNaMatriz (matrizCartas[j+1], matriz2, i1);
    insereCombNaMatriz (matrizCartas[j+2], matriz3, i2);
...
void geraDuplasSequencias8 ( wchar_t** matrizCartas,int j, int i, int i1 , int i2, int i3) {
    ...
    insereCombNaMatriz (matrizCartas[j+1], matriz2, i1);
    insereCombNaMatriz (matrizCartas[j+2], matriz3, i2);
    insereCombNaMatriz (matrizCartas[j+3], matriz4, i3);
...
void geraDuplasSequencias10 ( wchar_t** matrizCartas,int j, int i, int i1 , int i2, int i3, int i4) {
    ...
    insereCombNaMatriz (matrizCartas[j+2], matriz3, i2);
    insereCombNaMatriz (matrizCartas[j+3], matriz4, i3);
    insereCombNaMatriz (matrizCartas[j+4], matriz5, i4);
...
void duplaSequenciaUtil(MAO m, ULTIMA u, int start, int index, int r, int *passo) {
    ...
    for ( int i = 0 ; i < 9 ; i++ ) {
            ...
            geraDuplasSequencias10 (matrizCartas, i, numElementosPorLinha[i], numElementosPorLinha[i+1], numElementosPorLinha[i+2], numElementosPorLinha[i+3], numElementosPorLinha[i+4] );
            *passo = 1;
            }
        }
    }    
...
int printDuplaSequencia (MAO m, ULTIMA u) {
    ...
    int passo = 0;
    duplaSequenciaUtil(m, u, data, 0, 0, u->numUltima);
    return passo;
}
